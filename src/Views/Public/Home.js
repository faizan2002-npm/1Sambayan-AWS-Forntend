                            ...
                            slides.map((e, index) => {
                                ...
                                return (
                                    <Carousel.Item key={`id_${e._id}_${index}`}>
                                        <Image src={"http://redfruitfarm.in/views/uploads/" + e.backgroundImage} className="d-block w-100" alt="" fluid />
                                        {
                                            (index === 0) ? <>
                                                <Carousel.Caption>
                                                    <Container>
                                                        <Row className="justify-content-center">
                                                            <Col lg={10} md={10} xs={12}>
                                                                <Image src={"http://redfruitfarm.in/views/uploads/" + e.image} alt="" fluid />
                                                            </Col>
                                                        </Row>
                                                    </Container>
                                                </Carousel.Caption>
