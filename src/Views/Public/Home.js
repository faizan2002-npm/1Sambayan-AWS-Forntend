                            ...
                            slides.map((e, index) => {
                                ...
                                return (
                                    <Carousel.Item key={`id_${e._id}_${index}`}>
                                        <Image src={"http://ec2-52-206-101-95.compute-1.amazonaws.com/views/uploads/" + e.backgroundImage} className="d-block w-100" alt="" fluid />
                                        {
                                            (index === 0) ? <>
                                                <Carousel.Caption>
                                                    <Container>
                                                        <Row className="justify-content-center">
                                                            <Col lg={10} md={10} xs={12}>
                                                                <Image src={"http://ec2-52-206-101-95.compute-1.amazonaws.com/views/uploads/" + e.image} alt="" fluid />
                                                            </Col>
                                                        </Row>
                                                    </Container>
                                                </Carousel.Caption>
                            ...
                            <Col lg={10} md={10} xs={12}>
                                ...
                                }
                                {
                                    latestPosts.map((e, index) => (
                                        <PostCard key={`id_${e._id}_${index}`} heading={e.title} text={e.description} time={e.createdAt} video={"http://ec2-52-206-101-95.compute-1.amazonaws.com/views/uploads/" + e.image} image={false} grid={true} />
                                    ))
                                }
                                <Row>
                            ...
                            <Col lg={10} md={10} xs={12}>
                                <h1>{communitiesSection.heading}</h1>
                                {
                                    communities.map((e, index) => (
                                        <PostCard key={`id_${e._id}_${index}`} heading={e.title} text={e.description} time={e.createdAt} video={false} image={"http://ec2-52-206-101-95.compute-1.amazonaws.com/views/uploads/" + e.image} grid={true} />
                                    ))
                                }
                                <Row>
                                    <Col xs={12} className="d-flex justify-content-lg-end justify-content-center">
                                ...
                                <OwlCarousel className='owl-theme' {...carouselOptions} >
                                    {
                                        candidates.map((e, index) => (
                                            <PostCard key={`id_${e._id}_${index}`} text={e.title} image={"http://ec2-52-206-101-95.compute-1.amazonaws.com/views/uploads/" + e.image} grid={false} row={false} />
                                        ))
                                    }
                                </OwlCarousel>
                            </Col>
